            ...
            <Link to={ADMIN_DASHBOARD_ROUTE}>
                ...
                >
                    ...
                    <div className="space-y-1">
                        ...
                        className="w-full justify-start"
                        onClick={() => setActiveRoute(ADMIN_MANAGE_AGENTS_ROUTE)}
                    >
                        <BookCheck />Manage Les agents
                        </Button>
                            </Link>
                    </div>
                    <div className="space-y-1">
                        <Link to={ADMIN_MANAGE_CLIENTS_ROUTE}>
                            <Button
                                ...
                                className="w-full justify-start"
                                onClick={() => setActiveRoute(ADMIN_MANAGE_CLIENTS_ROUTE)}
                            >
                                <BookCheck />Manage Les Clients
                            </Button>
                        </Link>
                    </div>
                    <div className="space-y-1">
                        <Link to={ADMIN_MANAGE_OWNERS_ROUTE}>
                            <Button 
                                ...
                                className="w-full justify-start"
                                onClick={() => setActiveRoute(ADMIN_MANAGE_OWNERS_ROUTE)}
                            >
                                <UsersRound />Manage Les propriétaire
                            </Button>
                        </Link>
                    </div>
                </div>
